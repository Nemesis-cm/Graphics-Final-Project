...
// preserves the order in which objects are drawn, despite any performed operations.
var drawOrder = [];

// numOfType shows how many of each shape have been made
    ...
    switch(currentShape){
        case "Line":
            if(pointList.length > 1){
                ...
                // stores object type in resepective array
...
function translateHelper(event){
    ...
    // set new location for movement
    lastTransLoc = vec2(event.clientX - rect.left, event.clientY - rect.top);
    
    // run through selected objects and set new locations
    for(var i = 0; i < selectList.length; i++){
...
// cases to explain how to create the eight kinds of shapes
function shapeChanger(newShape){
    if(currentMode == "Create"){
        ...
        switch(shape){
            case "Line": 
                currentShape = "Line";
                explanation.innerHTML = "To create a Line, Just click two points on the canvas";
                break;
            case "Circle": 
                currentShape = "Circle";
                explanation.innerHTML = "To create a Circle,Just click two points on the canvas." + 
                                        " The first being the center point, the second being the radius.";
                break;
            case "Ellipse": 
                currentShape = "Ellipse";
                explanation.innerHTML = "To create an Ellipse, all you need to do is click on three points on the canvas." + 
                                        " One for the center point, and two for radiusX and radiusY. ";
                break;
            case "Rectangle": 
                currentShape = "Rectangle";
                explanation.innerHTML = "To create a Rectangle, all you need to do is click on two points on the canvas." +
                                        " Each point represents opposite corners.";
                break;
            case "Triangle": 
                currentShape = "Triangle";
                explanation.innerHTML = "To create a Triangle, all you need to do is click on "+
                                        "three points on the canvas.";
                break;
            case "Polygon": 
                currentShape = "Polygon";
                explanation.innerHTML = "To create a Polygon, click to add as many points as you want, "+
                                        "double click to make the last point.";
                break;
            case "Curve":
                currentShape = "Curve";
                explanation.innerHTML = "To create a Curve, click four points on the canvas." +
                                        " first point, curve point, second curve point, last point.";
                break;
            case "Square":
                currentShape = "Square";
                explanation.innerHTML = "To create a Square, click two points on the canvas. The first is the center point,"+
                " and the second determines the size of each wall. "
                break;
            case "Polyline": 
...
function modeChanger(mode){ 
    ...
    if(drawOrder.length == 0 && mode != "Create"){
        explanation.innerHTML = "You haven't drawn any objects yet. draw first then change the mode";
    ...
    switch(mode){
        case "Translate": 
            ...
            explanation.innerHTML = "Select an object through the drop down menu, then you can move the object by holding ctrl + left click on the canvas and dragging your mouse. "+ 
                                    "The object will move in the same direction as your mouse";
            break;
        case "Scale": 
            currentMode = "Scale";
            explanation.innerHTML = "Select an object through the drop down menu, then you can scale the object by holding ctrl + left click" + 
                                    " on the canvas and dragging your mouse. By moving your mouse up and to the right you can increase the scale,"+
                                    " and moving it down and to the left will reduce the scale.";
            break;
        case "Rotate": 
            currentMode = "Rotate";
            explanation.innerHTML = "Select an object through the drop down menu, then you can rotate the object by holding ctrl + left click and dragging the mouse. "+
...
function saveCanvasAsImage(){
    ...
    image.setAttribute("download", "Canvas.jpeg");
...
function selectRGB(){
    ...
    if(RGB[0] > 255){
        ...
        if(RGB[1] > 255){
            ...
            RGB[2]++;
            if(RGB[2] > 255){
                window.alert("You have reached the object limit, please save the canvas and reload it.");
                return;
            }
        }
    }
